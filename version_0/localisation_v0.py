...
del_list = pays + ['cookie', 'musique', 'accueil', 'ville', 'villes',
                   'privacy', 'conditions', '501c', 'allemand', 'afrique',
                   'chef-lieu']
toutes_les_villes = []
for dico in liste_villes_par_pays_complet:
...
i = 0
test = []
# data_final est récupéré sur l'explorateur de variable du filtrage
